...
return [
    ...
    'tables' => [
        ...
        'furniture' => [
            'name' => env('AIRTABLE_FURNITURE_TABLE', 'furniture'),
        ],
        'users' => [
            'name' => env('AIRTABLE_USERS_TABLE', 'users'),
        ],
        'vendors' => [
            'name' => env('AIRTABLE_VENDORS_TABLE', 'vendors'),
        ],
        'designers' => [
            'name' => env('AIRTABLE_DESIGNERS_TABLE', 'designers'),
        ],
